    ...
    var getBulkImageData = function() {
        ...
        renderBulkImageSummary = function(bulkImageData) {
            var setting = way2enjoy_settings.api_lossy,
                ...
                header = '<p class="way2enjoyBulkHeader"><strong class="way2enjoyBulkHeader1">' + wp_way2_msgs.bulkc + ' &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </strong><span class="close-way2enjoy-bulk">&times;</span></p>',
		...
		//	console.log(setting1);	
            ...
            var $table = $('<table id="way2enjoy-bulk"></table>'),
                $headerRow = $('<tr class="way2enjoy-bulk-header"><td>' + wp_way2_msgs.nameuu + '</td><td style="width:120px">' + wp_way2_msgs.original_sz + '</td><td style="width:120px">' + wp_way2_msgs.way2enjoy_st + '</td></tr>');
                    ...
                    jqxhr = $.ajax({
                        ...
                        if (data.success && "undefined" == typeof data.message) {
                            ...
                            var $button = $("button[id='way2enjoyid-" + id + "']"),
								...
								if(quotaRema===undefined){var ramukaka='' + wp_way2_msgs.buy_msg + '';}else{var ramukaka=''+quotaRema+' ' + wp_way2_msgs.way2_lossy + ' ' + wp_way2_msgs.quotabal_dtls + '';	}								
